...
class TestBricklink:
    ...
    def test_resource_initialization(self, bricklink_client):
        ...
        assert bricklink_client.store_inventory._oauth_session == bricklink_client.oauth_session
        assert bricklink_client.catalog_item._oauth_session == bricklink_client.oauth_session
