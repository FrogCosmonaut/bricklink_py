...
from bricklink_py.utils import (
    handle_response, request, BaseResource, 
    BricklinkError, ResourceNotFoundError, 
...
class TestHandleResponse:
    ...
    def test_success_response(self, mock_response):
        ...
        response = mock_response(200, {'meta': {'code': 200}, 'data': {'test': 'success'}})
    ...
    def test_rate_limit_error(self, mock_response):
        ...
        response = mock_response(429, {'meta': {'code': 429, 'message': 'Rate limit exceeded'}})
    ...
    def test_authentication_error(self, mock_response):
        ...
        response = mock_response(401, {'meta': {'code': 401, 'message': 'Unauthorized'}})
...
class TestRequest:
    ...
    def test_get_request(self, mock_oauth_session):
        ...
        mock_response.json.return_value = {'meta': {'code': 200}, 'data': {'key': 'value'}}
    ...
    def test_post_request(self, mock_oauth_session):
        ...
        mock_response = MagicMock()
        mock_response.json.return_value = {'meta': {'code': 200}, 'data': {'created': True}}
    ...
    def test_put_request(self, mock_oauth_session):
        ...
        mock_response = MagicMock()
        mock_response.json.return_value = {'meta': {'code': 200}, 'data': {'updated': True}}
    ...
    def test_delete_request(self, mock_oauth_session):
        ...
        mock_response = MagicMock()
        mock_response.json.return_value = {'meta': {'code': 200}, 'data': {'deleted': True}}
