            ...
            'data': [
                {
                    ...
                    'cost': {'subtotal': '25.00', 'grand_total': '30.00', 'currency_code': 'USD'}
                },
                {
                    'order_id': 12345679,
                    ...
                    'cost': {'subtotal': '15.00', 'grand_total': '20.00', 'currency_code': 'USD'}
                }
            ]
        }
        ...
        mock_response.json.return_value = {
            ...
            'data': [
                [
                    {
                        'inventory_id': 123456,
                        'item': {'no': '3039', 'name': 'Slope 45 2 x 2', 'type': 'PART', 'category_id': 38},
                        'color_id': 1,
                        'color_name': 'Blue',
                        'quantity': 2,
                        'unit_price': '0.25',
                    ...
                    {
                        'inventory_id': 123457,
                        'item': {'no': '3040', 'name': 'Slope 45 2 x 1', 'type': 'PART', 'category_id': 38},
                        'color_id': 5,
                        'color_name': 'Red',
                        'quantity': 3,
                        'unit_price': '0.20',
